...
const dbUrl='mongodb+srv://shalinijhajharia:Shalini1234@shalinicluster.oqii7.mongodb.net/Celebrities?retryWrites=true&w=majority'
...
app.delete('/celebrities/:id', async function(req,res){
